...
void gltfModel::setProjection(glm::mat4 projection)
{
...
void gltfModel::rotate(float x, float y, float z)
{
...
void gltfModel::translate(float x, float y, float z)
{
...
void gltfModel::scale(float x, float y, float z)
{
    glm::mat4 identityMatrix = glm::mat4(1.0f);
...
std::map<int, GLuint> gltfModel::bindMesh(std::map<int, GLuint> vbos, tinygltf::Model &model, tinygltf::Mesh &mesh)
{
...
GLuint gltfModel::bindModel(tinygltf::Model &model)
{
...
void gltfModel::drawMesh(tinygltf::Model &model, tinygltf::Mesh &mesh)
{
	for (size_t i = 0; i < mesh.primitives.size(); ++i)
	{
    	tinygltf::Primitive primitive = mesh.primitives[i];
...
void gltfModel::drawModelNodes(tinygltf::Model &model, tinygltf::Node &node)
{
		if ((node.mesh >= 0) && (node.mesh < model.meshes.size()))
		{
...
void gltfModel::drawModel(GLuint vao, tinygltf::Model &model)
{
	glBindVertexArray(vao);
...
void gltfModel::draw(Camera camera)
{
	shader->use();
...
void gltfModel::dbgModel(tinygltf::Model &model)
{
